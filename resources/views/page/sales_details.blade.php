                                        ...
                                        <table id="printhr">
                                            ...
                                            <tr>
                                                    ...
                                                    <td id="rights" style="width: 40vw !important; text-align: right; " colspan="2">
                                                        <span style="" id="title">Invoice</span>
                                                        <br><br>
                                                        <table>
                                                                <br>
...
{{--                                                                          
                                        ...
                                        <table id="demo-dynamic-tables-2" class="table table-middle">
                                                ...
                                                <tr id="detailtable">
                                                    ...
                                                    <td id="headers" style="text-align: center">Invoice #</td>
                                                    ...
                                                    <td id="headers" style="text-align: center">Invoice Type</td>
                                                        ...
                                                        if ($max=='1')
                                                            {
                                                                ...
                                                                {
                                                                    echo "<span class='label label-danger'>CREDIT</span>";
                                                                }
                                                        ?></td>

                                                    <td id="headers" style="text-align: center">Invoice Date</td>
                                                    <td style="text-align: center">{{ date('d-m-Y',strtotime($rows->date))}}
                                                </tr>
                                        ...
                                        <table id="demo-dynamic-tables-2" class="table table-middle">
                                              <tr id="total">
                                                <td id="headers" style="text-align: center">No</td>
                                                <td id="headers" style="text-align: center">Description</td>
                                                <td id="headers" style="text-align: center">Quantity</td>
                                                <td id="headers" style="text-align: center">Price Per Item</td>
                                                <td id="headers" style="text-align: center">Per Item Total</td>
                                                {{-- <td id="headers">Sales Type</td> --}}
                                            </tr>
                                            <?php $total = 0;$id=1;?>
                                            @foreach($row as $rows)
                                                ...
                                                @foreach($get as $gets)
                                                    <tr id="detailtable">
                                                        ...
                                                        <td style="text-align: center">{{$gets->quantity}}</td>
                                                        <td style="text-align: center">
                                                            <?php
                                                        ...
                                                        ?>
                                                        <td style="text-align: center"><?php $sales_tot= $sales_price * $gets->quantity;?>
                                                        {{ $sales_tot }}
                                                        </td>
