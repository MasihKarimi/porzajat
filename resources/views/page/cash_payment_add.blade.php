<div class="alert alert-info" id="headeradd" style=" border: 0px solid black;" xmlns="http://www.w3.org/1999/html">
    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal"><i
                class="sidenav-icon icon icon-plus"></i> Add Cash Payment
    </button>
    ...
    <form class="pull-right" method="post" action="{{url('/cashpSearch')}}">
        <div class="col-sm-3 pull-right input-group" style="margin-top: -35px">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <input type="text" name="id" placeholder="Search for Serial Nos. " class="form-control">
    ...
    <div class="modal-dialog" role="document"
        ...
        <div class="modal-content">
            <form id="demo-form-wizard-1" novalidate method="post" data-toggle="validator"
                  enctype="multipart/form-data" action="{{url('/cash_payment_add')}}">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add Cash Payment</h4>
                </div>
                <div class="modal-body" style="height: 60vh; overflow-y: auto">
                        <input type="hidden" name="user_id" value="{{$_SESSION['access']}}">
                    <div class="row">
                        ...
                        <script type="text/javascript">
                            $(document).ready(function () {
                                $('.edit').change(function () {
                                    var id = $(this).val();
                                    //$('#tl ').html("Loading...");
                                    //$('#tl').load('{{ url("money_receive_add") }}/' + id);
                                    $.ajax({
                                        type:"GET",
                                        url:'money_payment_add/'+id,
                       ...
                       {{--  <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4">
                                <label class="control-label">Total Loan On Us</label>
                            </div>
                            <div class="col-sm-7 input-group">
