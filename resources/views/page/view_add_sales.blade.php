    ...
    <div class="row">
        <div class="box col-md-12">
                <div class="alert alert-info" id="headeradd" style=" border: 0px solid black;" xmlns="http://www.w3.org/1999/html">
                    <a type="button" class="btn btn-info" href="{{ url('/view_sales') }}" ><i
               ...
               <div class="panel-heading">
                   <div class="panel-body">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            $('.button').click(function () {
                                ...
                                $('#result').load('{{ url("productAdd") }}/' + customer_id + '/' + product_id + '/' + quantity + '/' +mid+ '/' +c_c_money+ '/' +phone+ '/' +name+ '/' +sales_price+'/'+c_date);;
                    ...
                    <div style="float:right;">
                            <a href="{{url('product_salesdetail', $ids+$idperSale)}}" title="Details of the Record Shows">
                                    Generate Invoice
