                                                ...
                                                @foreach($row as $rows)
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap !important;">
                                                            ...
                                                            <a href="{{url('cash_receive_detail',$idR)}}"  title="Details of the Record Shows">
                                                            ...
                                                            @if($user->type==1)
                                                            <a href="{{url('cash_receive_updates',$idR)}}" title="Update this Record ">
                                                        ...
                                                        @include('page.cash_receive_delete')
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
