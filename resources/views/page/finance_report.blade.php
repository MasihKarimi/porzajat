...
@section('content')
    <div style="margin-top: -25px;">
        <ul class="breadcrumb col-md-12" style="background-color: rgba(228, 227, 229, 0.62)">
            <li><a reception_reportef="#">Expenses </a></li>
                                                ...
                                                <table id="demo-dynamic-tables-2" class="table table-middle">
                                                    ...
                                                    @foreach($ros as $rows)
                                                        ...
                                                        <tr id="detailtable">
                                                            ...
                                                            <td id="databody">{{number_format($rows->amount)}}&nbsp;
                                                            ...
                                                            <td id="databody" style=" width: auto;" >{{$rows->remark}}</td>
                                                    ...
                                                    <tr id="detailtable">
                                                        ...
                                                        <th id="datahead">Expanses Type</th>
                                                        <th id="datahead">Date</th>
                                                        <th id="datahead">Res Person Name</th>
                                                        <th id="datahead">Amount</th>
                                                    ...
                                                    @foreach($ros as $rows)
                                                        ...
                                                        <tr id="detailtable">
                                                            ...
                                                            <td id="databody"><?php
                                                                ...
                                                                @endforeach</td>
                                                            <td id="databody">{{$rows->date}}</td>
                                                            <td id="databody">{{ $rows->r_name }}</td>
                                                            <td id="databody">{{number_format($rows->amount)}}&nbsp;
                                                                <?php $totalPa = $totalPa + $rows->amount?>
                                                            </td>
                                                            <?php $tot=0; ?>
                                                            <?php
                                                            $rosale = DB::table("sales")->where('giveback', '=', 'true')->get();
                                                            $tot = 0;
                                                            ?>
                                                            ...
                                                            <td id="databody">{{$rows->remark}}</td>

                                                        </tr>
                                                    @endforeach
                                                    <tr id="detailtable">
                                                        <th colspan="4" id="datahead"
                                                            style="">
                                                            Total Amount
                                                        </th>
                                                        <th colspan="1" id="datahead"
    ...
    <div class="modal-dialog" role="document"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"> Expenses Report</h4>
            </div>
            <form method="post" action="{{url('/create_report_expense')}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 input-group">
                            <select class="form-control" name="section" required>
                                ...
                                ?>
                                @foreach($receptName as $name)
                                    <option value="{{$name->id}}">{{$name->expensesna}}</option>
                                @endforeach
