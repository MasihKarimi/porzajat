                                  ...
                                  <!--  <div class="form-group">
                                    ...
                                    <div class="form-group" style="background-color: #f0f0f0">
                                        ...
                                        <div class="col-sm-7 input-group" id="bene">
                                            <input type="text" value="" style="background-color: rgba(255, 255, 255, 0.35)"
                                                   name="bene" id="bene" class="form-control"> <span
                                                    class="input-group-addon"></span>
                                        </div>
                                    </div>
                                    <script type="text/javascript">
                        ...
                        <script type="text/javascript">
                            $(document).ready(function () {
                                $('.button').click(function () {
                                    var buyerName = $("#customer").val();
                                    var recept_id = $("#recept_id").val();
                                    var quantity = $("#quantity").val();
                                    var tsales = $("#sales").find("#sales").val();
                                    var salestype = $("#salestype").val();
                                    var currencyType = $("#idcurency").val();
                                    var mid = $("#bene").find("#bene").val();
                                    var bene=$("#mid").val();
                                    var payBill=$("#bill").val();
                                    var perce=$("#percent").val();
                                    $('#result').html(" <label>Loading... </label>");
                                    $('#result').load('<?php echo e(url("medicineAdd")); ?>/' + buyerName + '/' + recept_id + '/' + quantity + '/' + tsales +  '/' + salestype +   '/' + currencyType + '/' + mid + '/' +bene + '/' + payBill + '/'+perce);;
                                });
                            });
                        </script>
                        <div id="result"></div>
