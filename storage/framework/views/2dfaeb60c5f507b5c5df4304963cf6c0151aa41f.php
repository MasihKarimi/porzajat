...
<?php $__env->startSection('content'); ?>
    ...
    <div style="margin-top: -25px;">
        <ul class="breadcrumb col-md-12" style="background-color: rgba(228, 227, 229, 0.62)">
            ...
            <li><a href="<?php echo e(url('/add_sale')); ?>">Add Sales</a></li>
        </ul>
    </div>
            ...
            <div class="box-inner">
                <div class="box-content">
                        <div class="alert alert-info" id="headeradd" style=" border: 0px solid black;" xmlns="http://www.w3.org/1999/html">
                            <a type="button" class="btn btn-info" href="<?php echo e(url('/add_sales')); ?>" ><i
                        ...
                        border: 0px solid black;">
                            ...
                            <form class="pull-right" method="post" action="<?php echo e(url('/searchStockView')); ?>">
                                <div class="col-sm-3 pull-right input-group" style="margin-top: -35px">
                                                ...
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        $('.button').click(function () {
                                                            ...
                                                            $('#result').load('<?php echo e(url("productAdd")); ?>/' + customer_id + '/' + product_id + '/' + quantity + '/' +mid+ '/' +c_c_money+ '/' +phone+ '/' +name+ '/' +disc);;
