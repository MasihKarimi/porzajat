                                                    ...
                                                    <?php $__currentLoopData = $ros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        ...
                                                        <tr id="detailtable">
                                                            <td id="databody"><?php echo e($id); ?><?php
                                                                ;$id++;?></td>
                                                            <?php
                                                            $custName = DB::table("customers")->where('id', $rows->customer_id)->get();
                                                            ?>
                                                            ...
                                                            <td id="databody">
                                                                ...
                                                                <?php $__currentLoopData = $mids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemsName): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                    <?php if ($mids = DB::table("products")->where('id', $itemsName->product_id)->first()) {
                                                                        ...
                                                                        $totalPa = $itemsName->total_price + $totalPa;
                                                                    ?>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                            </td>

                                                            <td id="databody"> <?php echo $itemsName->total_price ?>&nbsp;
                                                                <?php $totalIncomes=$totalIncomes+$totalPa;?>



                                                            </td>
                                                            <td id="databody">  <?php if($itemsName->sales_type == '1'): ?> <span class="label label-danger time" title="this amount is debt"><?php echo $itemsName->total_price ?>&nbsp; </span><?php endif; ?>  <?php if($itemsName->sales_type == '2'): ?> <span title="this amount is credit" class="label label-success time"><?php echo $itemsName->total_price ?>&nbsp;</span> <?php endif; ?>
                                                               </td>
                                                           </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
...
<div class="modal fade lg modal1" tabindex="-1" id="report" role="dialog" style=" color: black;">
    ...
    <div class="modal-dialog" role="document"
        ...
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo e(url('/create_report_sales')); ?>">
