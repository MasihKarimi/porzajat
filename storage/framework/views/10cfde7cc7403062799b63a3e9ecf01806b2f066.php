        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-content">
                    ...
                    <?php echo $__env->make('page.setting_add_unit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-dynamic-tables-2" class="table table-middle">
                                            ...
                                            <tr>
                                                <th id="hid" )></th>
                                                <th>ID</th>
                                                <th style="width: 100%">Unit Name</th>
                                            ...
                                            <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 75%"><?php echo e($rows ->unit_na); ?> </td>
                                                    <?php $idR = '' . $rows->id . '';?>
                                                    <td style="white-space: nowrap !important;">
                                                        <a href="<?php echo e(url('/unitselectupdates',$idR)); ?>" title="Update this Record ">
                                                ...
                                                <?php echo $__env->make('page.setting_unit_delete', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
