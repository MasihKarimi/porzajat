                                                        ...
                                                        <tr id="detailtable">
                                                            ...
                                                            <td id="databody">
                                                                ...
                                                                <?php $__currentLoopData = $mids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemsName): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                    <?php if ($mids = DB::table("stocks")->where('product_id', $itemsName->product_id)->first()) {
                                                                        echo $itemsName->quantity. " " . $mids->unit . "<br>";
                                                                    }
                                                            ...
                                                            <td id="databody">
                                                                <?php
                                                                $ros = DB::table("stocks")->take(1)->where('product_id', $itemsName->product_id)->get();
                                                                $total = 0;

                                                                ?>
                                                                <?php $__currentLoopData = $ros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ro): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                    <?php echo $sales_price = $ro->sales_price ?>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>


                                                                <?php $total=$total+($itemsName->quantity * $ro->sales_price) ?>&nbsp;
                                                            ...
                                                            <td id="databody">
                                                                ...
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                                <?php  echo $total=$total+($itemsName->quantity * $ro->sales_price) ?>&nbsp;
                                                               </td>
                                                           </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
