                        ...
                        <table class="table responsive  table-hover dataTable table-borderd " id="sample_1" role="grid" aria-describedby="sample_1" style="font-size: 14px; border: 1px solid black;">
                            ...
                            <?php $__currentLoopData = $CustShow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr role="row" class="odd item<?php echo e($item->id); ?>" >
                                    ...
                                    <td>
                                        <p style="display: none"> <?php echo e($id = $item->id); ?></p>

                                    <?php $totalReceive=0;

                                    $dbAllReceive=DB::table('cash_paids')->where('customer_id',$id )->get(); ?>
                                    <?php $__currentLoopData = $dbAllReceive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jan): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <?php $totalReceive=$totalReceive+$jan->tl_amount; ?>

                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                    <b><?php echo e($totalReceive); ?> </b>
                                    </td>
                                    <td>
                                        <p style="display: none"> <?php echo e($id = $item->id); ?></p>
                                    ...
                                    <?php $totalReceive=0;
                                        ...
                                        <?php $__currentLoopData = $dbAllReceive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jan1): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        ...
                                        <?php $__currentLoopData = $dbAllReceive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jan2): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <?php $totalResales=$totalResales+($jan2->quantity * $jan2->sales_price); ?>

                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                        <b><?php echo e($totalResales-$totalReceive); ?> </b>
                                    </td>
                                    ...
                                    <td style="white-space: nowrap !important;">
                                        ...
                                        <a href="<?php echo e(url('/seeCustomerRecord/'.$item->id)); ?>"  class="btn btn-info">
                                        See Records</a>
                                    </td>
                                    <?php endif; ?>
                                </tr>
