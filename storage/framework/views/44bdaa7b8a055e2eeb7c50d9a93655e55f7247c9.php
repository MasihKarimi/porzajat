                                                    ...
                                                    <?php $__currentLoopData = $ros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        ...
                                                        <tr id="detailtable">
                                                            ...
                                                            <?php if($itemsName->sales_type == '1'): ?>
                                                                <td id="databody" title="this amount is debt"><span class="label label-danger time"> <?php echo $itemsName->mid ?>&nbsp;</span>
                                                                    <?php endif; ?>
                                                                    <?php if($itemsName->sales_type == '2'): ?>
                                                                <td id="databody"  title="this amount is credit"><span class="label label-success time"> <?php echo $itemsName->mid ?>&nbsp;</span>
                                                                    <?php endif; ?>
