    ...
    <div class="layout-content-body">
        <div style="margin-top: -25px;">
            <ul class="breadcrumb col-md-12" style="background-color: rgba(228, 227, 229, 0.62)">
                ...
                <li><a href="<?php echo e(url('/add_company')); ?>">Add Company</a></li>
            </ul>
        </div>
                            ...
                            <div class="modal fade lg modal1" tabindex="-1" id="myModal" role="dialog"
                                ...
                                <div class="modal-dialog" role="document"
                                    ...
                                    <div class="modal-content">
                                        <form id="example-form-company" novalidate="novalidate" method="post"
                                        ...
                                        >
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p>
                                                            <label for="product_name">Enter Company Name</label>
                                                            <input class="form-control" id="comp_name" name="comp_name" type="text">
                                                            <br>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable dtr-inline" id="sample_1" role="grid" aria-describedby="sample_1_info" style=" font-size: 14px; border: 1px solid black; width: 40%; margin-left: 20%">
                            ...
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1"
                                    ...
                                    aria-label="Name: activate to sort column descending">Company Name
                                </th>
                            ...
                            <?php $__currentLoopData = $CompShow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr role="row" class="odd item<?php echo e($item->id); ?>" >
                                    <td tabindex="0" class="sorting_1"><?php echo e($item->comp_name); ?></td>
                                    <td style="white-space: nowrap !important;">
                                        <button class="edit-modal1 btn btn-info" data-id="<?php echo e($item->id); ?>"
                                                data-name="<?php echo e($item->comp_name); ?>"
                                        >
                                            <span class="glyphicon glyphicon-edit"></span> Edit
                                        </button>
                                        <button class="delete-modals1 btn btn-danger"
                                                data-id="<?php echo e($item->id); ?>" data-name="<?php echo e($item->comp_name); ?>">
                            ...
                            <div class="col-md-10 col-sm-12">
                                <div class="dataTables_paginate paging_bootstrap_number" id="sample_1_paginate">
                                    <ul class="pagination" style="visibility: visible;">
                                        <li class="active"><?php echo e($CompShow->links()); ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
