    ...
    <div class="login">
      <div class="login-body">
        <a class="login-brand" href="#">
            <img src="<?php echo e(URL::asset('assets/image/logo.png')); ?>" width="70%" style="height: auto; margin-left: 5%">
        </a>
        <div class="login-form">
          <form data-toggle="validator"  role="form" method="POST" action="<?php echo e(url('/login')); ?>">
      ...
      <div class="login-footer">
         HamidLemar Ltd<br>
          Copy &copy;   By <a href="https://facebook.com/mujeeb.haleemi"> Mujib Halimi </a>
      </div>
    </div>
