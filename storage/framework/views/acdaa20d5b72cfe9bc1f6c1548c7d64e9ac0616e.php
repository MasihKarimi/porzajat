        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-content">
                    <?php echo $__env->make('page.cash_receive_add', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                                ...
                                                <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap !important;">
                                                            ...
                                                            <a href="<?php echo e(url('cash_receive_detail',$idR)); ?>"  title="Details of the Record Shows">
                                                            ...
                                                            <?php if($user->type==1): ?>
                                                            <a href="<?php echo e(url('cash_receive_updates',$idR)); ?>" title="Update this Record ">
                                                        ...
                                                        <?php echo $__env->make('page.cash_receive_delete', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                </tbody>
                                            </table>
