                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <label class="control-label">Chose Customer Name </label>
                                        </div>
                                        <div class="col-sm-7 input-group">
                                            <select class="chzn-select form-control"
                                                ...
                                                <?php
                                                $ros = DB::table("customers")->where('id',isset($edit_sales) ? $edit_sales->customer_id : '')->get();
                                                ?>
                                                <?php $__currentLoopData = $ros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ro): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                    <option value="<?php echo e($ro->id); ?>"> <?php echo e($ro->name); ?>&nbsp;<?php echo e($ro->address); ?></option>

                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>

                                                <?php
                                                $ross = DB::table("customers")->get();
                                                ?>
                                            ...
                                            <font style="color: red;"> The Current Customer Is : <span style="font-weight: bold;">
                                                      <?php
                                                    $ros = DB::table("customers")->where('id',isset($edit_sales) ? $edit_sales->customer_id : '')->get();
                                                    ?>
                                                          <?php $__currentLoopData = $ros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ro): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                              <?php echo e($ro->name); ?>&nbsp;<?php echo e($ro->address); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" style="background-color: #f0f0f0">
                                        ...
                                        <div class="col-sm-7 input-group" id="bene">
                                            <input type="text" value="" style="background-color: rgba(255, 255, 255, 0.35)"
                                                   name="bene" id="bene" class="form-control totalsale"> <span
                                                    class="input-group-addon"></span>
                                        </div>
                                    </div>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('.edit').change(function () {
                                                var percen = $(this).val();
                                                var price = $("#tsalesm").val();
                                                var ben=$("#mid").val();
                                                $('#sales ').html("<input type='text' value='Loading ...' style='background-color: rgba(255, 255, 255, 0.35)' name='sales' id='sales' class='form-control'>  <span class='input-group-addon'></span>");
                                                $('#sales ').load('<?php echo e(url("procurementSales")); ?>/' + percen + '/' + price);
                                                $('#bene ').html("<input type='text' value='Loading ...' style='background-color: rgba(255, 255, 255, 0.35)' name='bene' id='bene' class='form-control'>  <span class='input-group-addon'></span>");
                                                $('#bene ').load('<?php echo e(url("procurementSalesben")); ?>/' + percen + '/' + ben);
