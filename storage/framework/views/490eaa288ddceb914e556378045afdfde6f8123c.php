...
<head>
   ...
   <link rel="icon" type="image/png" href="<?php echo e(asset('logo.png')); ?>" sizes="32x32">
    <link rel="icon" type="image/png" href="<?php echo e(asset('logo.png')); ?>" sizes="16x16">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown hidden-xs" style="color: red; ">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a></a></li>
                            <li>
                                <a id="logout" href="<?php echo e(url('/updateUser/'.$_SESSION['access'])); ?>">
