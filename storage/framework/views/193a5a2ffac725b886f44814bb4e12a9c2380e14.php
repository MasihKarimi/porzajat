                    ...
                    <i class="icon icon-search" style="font-size: larger;font-weight: bold"></i>
                                        ...
                                        <form id="example-form" novalidate="novalidate" method="post"
                                                        ...
                                                        <div class="col-sm-3" style="padding-left: 0px !important;">
                                                            <select class="form-control" required name="unit"
                                                              ...
                                                              $ros = DB::table("setting_unit")->get();
                                                                ...
                                                                <option value="<?php echo e($ro->unit_na); ?>"><?php echo e($ro->unit_na); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                            </select>
                                                        </div>
                                                        </p>
                                            ...
                                            <div class="modal-footer">
                                                <div style="padding-top: 0px;">
                                                    ...
                                                    <a href="<?php echo e(url('/view_purchase')); ?>" class="btn btn-default">
                                                    Close
                                                    </a>
                        ...
                        <table class="table responsive table-striped table-bordered table-hover dataTable dtr-inline" id="sample_1" role="grid" aria-describedby="sample_1_info" style=" font-weight: bold; font-size: 11px; border: 1px solid black; width: 100%;">
                            ...
                            <tr role="row" style="font-size: 14px;" class="odd">
                                ...
                                <td><?php if($item->sales_type==0): ?><span class="label label-danger">Debt</span><?php else: ?> <span class="label label-success">Credit</span> <?php endif; ?></td>
