+function (a) {
    ...
    function b(b) {
        return this.each(function () {
            var d = a(this), e = d.data("bs.input");
    ...
    var c = {connect: "lower", cssPrefix: "slider-", max: 100, min: 0, range: {}, slider: "default", start: 0};
    a.fn.slider = function (a) {
        ...
        if (b.slider(c), c.target && c.target.length) {
            var d = b.slider("instance"), e = a(c.target.toString());
    ...
    a.validator.setDefaults({
        ...
        errorPlacement: function (a, b) {
            var c = b.closest("form"), d = b.parents(".form-group").last();
            c.hasClass("form-horizontal") && (d = b.parent()), a.addClass("help-block").appendTo(d)
        },
        highlight: function (b, c, d) {
            var e = a.extend({}, this.settings), f = a(b).closest(".form-group");
